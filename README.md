...
- Guangya live upload helper via `scripts/create_live_upload_task.py` for refreshing latest auth evidence and producing task snapshots plus auth/runtime/real/remediation evidence markdown
