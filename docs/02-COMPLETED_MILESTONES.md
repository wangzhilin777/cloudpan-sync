...
- 完成范围：
  ...
  - provider 面板现也会直接展示 `task_runtime_track` 与说明文本，可一眼区分“Guangya / aliyundrive_open / 123_open 已在 runtime_active”“189cloud 当前 runtime_blocked”“其余已接 live list/metadata/create_dir 的 provider 属于 runtime_candidate”
