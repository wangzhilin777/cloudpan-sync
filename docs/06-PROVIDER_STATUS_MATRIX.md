...
- GeneratedAt: `2026-05-24T12:29:49.135311+00:00`
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 115_open | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| 123_open | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| 189cloud | list_ready | False | True | True | True | True | False | runtime_candidate | 0 | 0 | 0 | False | False | readonly_auth_blocked | unsupported | unsupported | (none) | True |
...
| aliyundrive_open | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| baidu_netdisk | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| guangya | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | True | downgrade_to_auto_rename | downgrade_to_auto_rename | supported | overwrite_existing, auto_rename_new | True |
...
| pikpak | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| quark | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| uc | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
...
| xunlei | list_ready | False | True | True | True | True | False | runtime_active | 0 | 0 | 0 | False | False | not_implemented | unsupported | probe_only_runtime_write_check | (none) | True |
