...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--target-provider", default="guangya", help="Target provider key. Currently supports guangya, aliyundrive_open, and 123_open.")
    ...
    if target_provider not in {"guangya", "aliyundrive_open", "123_open"}:
