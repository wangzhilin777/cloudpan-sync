        ...
        json.dumps(
            {
                ...
                and 'let firstAuditGapOrphanItems = [];' in app_js
                and 'firstAuditGapOrphanItem = firstAuditGapOrphanItems[0] || null;' in app_js
                and 'firstAuditGapOrphanItems = firstAuditGap.key === "M4"' in app_js
                ...
                and 'appendRuntimeOrphanRecreateButtons(' in app_js
                and 'firstAuditGap.key === "M4" ? "Recreate Guangya Orphan Stub" : "Recreate Orphan Stub"' in app_js
                ...
                "auditSettingsUiFlowIsWired": (
                    ...
                    and 'state.activeTab = "nav.providers";' in app_js
                    and 'state.activeTab = "nav.auth";' in app_js
                    and 'const audit = state.auditSummary || {};' in app_js
                    and 'done=' in app_js
                    and 'partial=' in app_js
                    and 'todo=' in app_js
                    and 'featureCompletionPercent=' in app_js
                    and 'strictCompletionPercent=' in app_js
                    and 'providerCount=' in app_js
                    and 'researchCount=' in app_js
                    and 'gaps=${firstAuditGap.gaps || "(none)"}' in app_js
                    and 'state.auditSummary = null;' in app_js
                    and 'state.auditItems = [];' in app_js
                ),
            },
            ensure_ascii=False,
            indent=2,
