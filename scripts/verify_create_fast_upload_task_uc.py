...
def main() -> None:
    ...
    evidence_dir = ROOT / "tmp" / "verify-uc-fast-task-evidence-bundle"
    ...
    fast_upload_script.task_runtime.upload_uc_fast_file = fake_upload
    ...
    try:
        ...
        fast_upload_script.task_runtime.upload_uc_fast_file = original_upload
        ...
        json.dumps(
            {
                ...
                "authEvidenceRefreshed": len(refresh_calls) == 1 and refresh_calls[0].get("profileId") == "uc-fast-1",
