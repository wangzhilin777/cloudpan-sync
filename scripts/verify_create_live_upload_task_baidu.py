...
def main() -> None:
    ...
    evidence_dir = ROOT / "tmp" / "verify-baidu-live-evidence-bundle"
    ...
    live_upload_script.task_runtime.upload_baidu_local_file = fake_upload
    ...
    try:
        ...
        live_upload_script.task_runtime.upload_baidu_local_file = original_upload
        ...
        json.dumps(
            {
                ...
                "authEvidenceRefreshed": len(refresh_calls) == 1 and refresh_calls[0].get("profileId") == "bd-live-1",
