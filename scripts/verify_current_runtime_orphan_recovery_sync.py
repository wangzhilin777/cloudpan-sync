        ...
        json.dumps(
            {
                ...
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile gy-live-1`" in guangya
                ...
                "guangyaLive2SectionHasExactRuntimeHelpers": "exactCreateHelper: `.\\.venv\\Scripts\\python.exe scripts\\create_auth_profile_stub.py --from-runtime-orphan-profile gy-live-2`" in guangya_live_2
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile gy-live-2`" in guangya_live_2
                ...
                "guangyaDefaultsSectionHasExactRuntimeHelpers": "exactCreateHelper: `.\\.venv\\Scripts\\python.exe scripts\\create_auth_profile_stub.py --from-runtime-orphan-profile gy-live-defaults-1`" in guangya_defaults
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile gy-live-defaults-1`" in guangya_defaults
                ...
                "guangyaOrphanLiveSectionHasExactRuntimeHelpers": "exactCreateHelper: `.\\.venv\\Scripts\\python.exe scripts\\create_auth_profile_stub.py --from-runtime-orphan-profile gy-orphan-live-1`" in guangya_orphan_live
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile gy-orphan-live-1`" in guangya_orphan_live
                ...
                "pikpakSectionHasExactRuntimeHelpers": "exactCreateHelper: `.\\.venv\\Scripts\\python.exe scripts\\create_auth_profile_stub.py --from-runtime-orphan-profile pikpak-live-1`" in pikpak
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile pikpak-live-1`" in pikpak
                ...
                "ucSectionHasExactRuntimeHelpers": "exactCreateHelper: `.\\.venv\\Scripts\\python.exe scripts\\create_auth_profile_stub.py --from-runtime-orphan-profile uc-live-1`" in uc
                and "exactRefreshEvidenceHelper: `.\\.venv\\Scripts\\python.exe scripts\\patch_and_probe_auth_profile.py --from-runtime-orphan-profile uc-live-1`" in uc
