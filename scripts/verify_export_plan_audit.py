        ...
        "items": [
            {
                ...
                "gaps": "真实秒传 API 成功样本仍缺；`pikpak / uc` 的 runtime_orphan 样本暂不能当成可复验证据。",
            },
            {
                "key": "P-REAL",
                "title": "真实联调验证",
                "status": "todo",
                "evidence": "已具备本地 mock 验证链路与真实证据状态报告，且已识别 `guangya / uc / pikpak` 的 runtime_orphan 样本。",
                "gaps": "尚未提供首批 provider 的真实联调成功证据；当前 runtime success 样本仍存在 auth profile 脱节。",
            },
        ],
    }
