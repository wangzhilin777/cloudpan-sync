    ...
    synthetic_payload = {
        ...
        "items": [
            ...
            },
            {
                ...
                "recommendedPostBootstrapRuntimeCommand": r".\.venv\Scripts\python.exe scripts\create_live_upload_task.py --target-provider quark --target-profile-id YOUR_PROFILE_ID --auto-temp-file --threshold-mb 1 --evidence-dir tmp\quark-post-bootstrap-runtime-evidence",
            ...
            },
            {
                ...
                "recommendedPostBootstrapRuntimeCommand": r".\.venv\Scripts\python.exe scripts\create_live_upload_task.py --target-provider baidu_netdisk --target-profile-id YOUR_PROFILE_ID --auto-temp-file --threshold-mb 1 --evidence-dir tmp\baidu_netdisk-post-bootstrap-runtime-evidence",
            ...
            },
            {
                ...
                "recommendedPostBootstrapRuntimeCommand": r".\.venv\Scripts\python.exe scripts\create_live_upload_task.py --target-provider xunlei --target-profile-id YOUR_PROFILE_ID --auto-temp-file --threshold-mb 1 --evidence-dir tmp\xunlei-post-bootstrap-runtime-evidence",
            ...
            },
            {
                ...
                "recommendedPostBootstrapRuntimeCommand": r".\.venv\Scripts\python.exe scripts\create_live_upload_task.py --target-provider 123_open --target-profile-id YOUR_PROFILE_ID --auto-temp-file --threshold-mb 1 --evidence-dir tmp\123_open-post-bootstrap-runtime-evidence",
