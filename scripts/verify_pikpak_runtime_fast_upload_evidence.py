...
def main() -> None:
    ...
    original_upload = task_runtime.upload_pikpak_fast_file
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        file_path.write_bytes(b"pikpak-fast-upload-demo")
        ...
        try:
            ...
            created = client.post(
                ...
                json={
                    ...
                    "targetProfileId": "pikpak-1",
                    "targetParentId": "root-pikpak",
                    "thresholdMB": 0,
            ...
            real_evidence_report.list_profiles = lambda: [
                type("Profile", (), {"profileId": "pikpak-1", "displayName": "PikPak Fast Upload", "providerKey": "pikpak"})()
            ]
            ...
            real_evidence_report.build_provider_registry = lambda: [
                type("RegistryItem", (), {"profile": type("Profile", (), {"providerKey": "pikpak", "displayName": "PikPak"})()})()
            ]
            ...
            task_runtime.upload_pikpak_fast_file = original_upload
