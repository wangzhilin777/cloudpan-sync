...
def main() -> None:
    ...
    original_create_dir = task_runtime.fetch_pikpak_create_folder
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        task_runtime.fetch_pikpak_create_folder = fake_create_dir
        ...
        try:
            ...
            real_evidence_report.list_profiles = lambda: [
                SimpleNamespace(profileId="pikpak-1", displayName="PikPak Smoke", providerKey="pikpak")
            ]
            ...
            task_runtime.fetch_pikpak_create_folder = original_create_dir
