        ...
        json.dumps(
            {
                ...
                and 'const orphanProfileId = String((remediationItem?.runtimeOrphanProfiles || [])[0] || "").trim();' in app_js
                ...
                and 'recreateBtn.addEventListener("click", () => recreateRuntimeOrphanProfile(providerKey, orphanProfileId));' in app_js
