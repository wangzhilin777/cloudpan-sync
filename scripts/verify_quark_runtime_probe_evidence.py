...
def main() -> None:
    ...
    original_create_dir = task_runtime.fetch_quark_create_folder
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        task_runtime.fetch_quark_create_folder = fake_create_dir
        ...
        try:
            ...
            real_evidence_report.list_profiles = lambda: [
                SimpleNamespace(profileId="quark-1", displayName="Quark Smoke", providerKey="quark")
            ]
            ...
            real_evidence_report.build_provider_registry = lambda: [
                SimpleNamespace(profile=SimpleNamespace(providerKey="quark", displayName="Quark"))
            ]
            ...
            task_runtime.fetch_quark_create_folder = original_create_dir
