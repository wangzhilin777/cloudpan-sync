        ...
        json.dumps(
            {
                ...
                "markdownHasProviderSummary": f"- providerSummary: `noProfiles={', '.join((bundle.get('summary') or {}).get('providersWithNoProfilesList', [])) or '(none)'}` `needAuth={', '.join((bundle.get('summary') or {}).get('providersNeedingAuthEvidenceList', [])) or '(none)'}` `needRuntime={', '.join((bundle.get('summary') or {}).get('providersNeedingRuntimeSuccessList', [])) or '(none)'}` `needSecretRefresh={', '.join((bundle.get('summary') or {}).get('providersNeedingSecretRefreshList', [])) or '(none)'}` `placeholderLiveRejected={', '.join((bundle.get('summary') or {}).get('providersPlaceholderLiveRejectedList', [])) or '(none)'}` `recreateProbe={', '.join((bundle.get('summary') or {}).get('providersWithRecreateProbeCommandList', [])) or '(none)'}` `primaryCommand={', '.join((bundle.get('summary') or {}).get('providersWithPrimaryCommandList', [])) or '(none)'}` `overwriteVariant={', '.join((bundle.get('summary') or {}).get('providersWithOverwriteVariantCommandList', [])) or '(none)'}` `blockedOnly={', '.join((bundle.get('summary') or {}).get('providersBlockedOnlyList', [])) or '(none)'}` `candidateOnly={', '.join((bundle.get('summary') or {}).get('providersCandidateOnlyList', [])) or '(none)'}` `probeOnly={', '.join((bundle.get('summary') or {}).get('providersProbeOnlyList', [])) or '(none)'}` `runtimeOrphanOnly={', '.join((bundle.get('summary') or {}).get('providersRuntimeOrphanOnlyList', [])) or '(none)'}`" in markdown,
                ...
                "apiMarkdownHasProviderSummary": f"providerSummary: `noProfiles={', '.join((bundle.get('summary') or {}).get('providersWithNoProfilesList', [])) or '(none)'}` `needAuth={', '.join((bundle.get('summary') or {}).get('providersNeedingAuthEvidenceList', [])) or '(none)'}` `needRuntime={', '.join((bundle.get('summary') or {}).get('providersNeedingRuntimeSuccessList', [])) or '(none)'}` `needSecretRefresh={', '.join((bundle.get('summary') or {}).get('providersNeedingSecretRefreshList', [])) or '(none)'}` `placeholderLiveRejected={', '.join((bundle.get('summary') or {}).get('providersPlaceholderLiveRejectedList', [])) or '(none)'}` `recreateProbe={', '.join((bundle.get('summary') or {}).get('providersWithRecreateProbeCommandList', [])) or '(none)'}` `primaryCommand={', '.join((bundle.get('summary') or {}).get('providersWithPrimaryCommandList', [])) or '(none)'}` `overwriteVariant={', '.join((bundle.get('summary') or {}).get('providersWithOverwriteVariantCommandList', [])) or '(none)'}` `blockedOnly={', '.join((bundle.get('summary') or {}).get('providersBlockedOnlyList', [])) or '(none)'}` `candidateOnly={', '.join((bundle.get('summary') or {}).get('providersCandidateOnlyList', [])) or '(none)'}` `probeOnly={', '.join((bundle.get('summary') or {}).get('providersProbeOnlyList', [])) or '(none)'}` `runtimeOrphanOnly={', '.join((bundle.get('summary') or {}).get('providersRuntimeOrphanOnlyList', [])) or '(none)'}`" in str(api_markdown.get("markdown", "")),
            },
            ensure_ascii=False,
            indent=2,
        )
