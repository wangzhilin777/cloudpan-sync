        ...
        json.dumps(
            {
                ...
                "jsSettingsRenderUsesRemediation": "settingsRealEvidenceRemediationList" in app_js and "providersWithNoProfiles" in app_js and "providersNeedingRuntimeSuccess" in app_js,
            },
            ensure_ascii=False,
            indent=2,
        )
