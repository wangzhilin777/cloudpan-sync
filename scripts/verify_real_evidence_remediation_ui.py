        ...
        json.dumps(
            {
                ...
                and "exactCreate=${item.exactCreateHelper}" in app_js
                and "exactRecreate=${item.exactRecreateHelper}" in app_js
                and "exactRefresh=${item.exactRefreshEvidenceHelper}" in app_js
                and "exactPostRefreshRuntime=${item.exactPostRefreshRuntimeHelper}" in app_js
                and "exactRuntime=${item.exactRuntimeProbeHelper}" in app_js
                and "exactRuntimeSuccess=${item.exactRuntimeSuccessHelper}" in app_js
                and "exactPostBootstrapRuntime=${item.exactPostBootstrapRuntimeHelper}" in app_js
                ...
                "jsRemediationRowsShowLiveRejectedState": "liveRejectedStatuses=${liveRejectedStatuses}" in app_js
