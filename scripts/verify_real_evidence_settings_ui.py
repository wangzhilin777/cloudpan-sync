        ...
        json.dumps(
            {
                ...
                "jsRenderSettingsUsesRealEvidence": 'const realEvidence = state.realEvidenceSummary || {};' in app_js and 'task_runtime=' in app_js and 'task_runtime_failed=' in app_js and 'runtime_samples=' in app_js and 'runtime_success=' in app_js and 'runtime_failed=' in app_js and 'fully_verified=' in app_js,
