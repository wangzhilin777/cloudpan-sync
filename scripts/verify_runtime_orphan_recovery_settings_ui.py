        ...
        json.dumps(
            {
                ...
                and 'focusBtn.textContent = "Focus First Match"' in app_js
                and 'refreshBtn.textContent = "Refresh First Match"' in app_js
                and 'probeBtn.textContent = "Probe First Match"' in app_js
