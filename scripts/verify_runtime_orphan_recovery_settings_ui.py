        ...
        json.dumps(
            {
                ...
                "jsSettingsRenderUsesRuntimeOrphanRecovery": "const orphanRecoverySummary = state.runtimeOrphanRecovery?.summary || {};" in app_js and "orphanProfilesList=" in app_js and "recreate=" in app_js and 'recreateBtn.addEventListener("click", () => recreateRuntimeOrphanProfile(item.providerKey, item.orphanProfileId));' in app_js,
            },
            ensure_ascii=False,
            indent=2,
        )
