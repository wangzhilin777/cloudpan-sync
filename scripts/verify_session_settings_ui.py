...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "htmlHasSessionPanel": "settingsSessionTitle" in html and "settingsSessionList" in html,
                "jsRenderSettingsUsesSessionSummary": 'const sessionRows = [' in app_js
                and 'summary.auth_profiles' in app_js
                and 'summary.tasks' in app_js,
                "jsSessionHasFirstGapActions": 'const firstSessionGap = !state.loggedIn' in app_js
