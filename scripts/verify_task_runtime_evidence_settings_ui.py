        ...
        json.dumps(
            {
                ...
                and 'recreateBtn.textContent = "Recreate First Runtime Orphan Stub";' in app_js
                and 'recreateRuntimeOrphanProfile(firstRuntimeOrphanItem.providerKey, firstRuntimeOrphanItem.profileId)' in app_js,
