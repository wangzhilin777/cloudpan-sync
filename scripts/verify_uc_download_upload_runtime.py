    ...
    def fake_upload(*, profile_id: str, local_path: str, target_name: str, parent_id: str = "", expected_md5: str = "", expected_sha1: str = "", conflict_policy: str = "auto_rename_new"):
        ...
        return type(
            ...
            (),
            {
                ...
                "verifyNote": "uc verified",
                "verifyPayload": {"usedBinaryFallback": True},
                "note": "uc direct local upload completed.",
                "error": "",
            },
        )()

    task_runtime.upload_uc_fast_file = fake_upload
    task_guard.get_profile = lambda profile_id: object() if profile_id == "uc-profile-1" else None
    ...
    try:
        task = task_runtime.create_task(
            TaskCreateRequest(
                ...
                targetProvider="uc",
                targetProfileId="uc-profile-1",
                targetParentId="uc-root",
                thresholdMB=200,
        ...
        task_runtime.upload_uc_fast_file = original_uc
