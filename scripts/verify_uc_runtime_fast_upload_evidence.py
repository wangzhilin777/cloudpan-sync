...
def main() -> None:
    ...
    original_upload = task_runtime.upload_uc_fast_file
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        file_path.write_bytes(b"uc-fast-upload-demo")
        ...
        task_runtime.upload_uc_fast_file = fake_upload
        ...
        try:
            ...
            real_evidence_report.list_profiles = lambda: [
                type("Profile", (), {"profileId": "uc-1", "displayName": "UC Fast Upload", "providerKey": "uc"})()
            ]
            ...
            real_evidence_report.build_provider_registry = lambda: [
                type("RegistryItem", (), {"profile": type("Profile", (), {"providerKey": "uc", "displayName": "UC Drive"})()})()
            ]
            ...
            task_runtime.upload_uc_fast_file = original_upload
