        ...
        json.dumps(
            {
                ...
                "htmlHasAuthModal": 'id="authModal"' in index_html and 'id="authOpenModalBtn"' in index_html and 'id="authStartCaptureBtn"' in index_html,
