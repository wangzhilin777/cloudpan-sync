...
def main() -> None:
    ...
    original_upload = task_runtime.upload_xunlei_fast_file
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        file_path.write_bytes(b"xunlei-fast-upload-demo")
        ...
        try:
            ...
            real_evidence_report.list_profiles = lambda: [
                type("Profile", (), {"profileId": "xunlei-1", "displayName": "Xunlei Fast Upload", "providerKey": "xunlei"})()
            ]
            ...
            real_evidence_report.build_provider_registry = lambda: [
                type("RegistryItem", (), {"profile": type("Profile", (), {"providerKey": "xunlei", "displayName": "Xunlei Drive"})()})()
            ]
            ...
            task_runtime.upload_xunlei_fast_file = original_upload
