...
def main() -> None:
    ...
    original_create_dir = task_runtime.fetch_xunlei_create_folder
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        task_runtime.fetch_xunlei_create_folder = fake_create_dir
        ...
        try:
            ...
            created = client.post(
                ...
                json={
                    ...
                    "targetProfileId": "xunlei-1",
                    "targetParentId": "root-xunlei",
                    "thresholdMB": 200,
            ...
            real_evidence_report.list_profiles = lambda: [
                SimpleNamespace(profileId="xunlei-1", displayName="Xunlei Smoke", providerKey="xunlei")
            ]
            ...
            task_runtime.fetch_xunlei_create_folder = original_create_dir
